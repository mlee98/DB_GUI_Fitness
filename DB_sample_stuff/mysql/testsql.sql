...
START TRANSACTION;
USE `DB_GUI`;
INSERT INTO `DB_GUI`.`User_info` (`userid`, `fName`, `lName`, `Height`, `Weight`, `Age`) VALUES (1, 'Jane', 'Doe', 5.7, 160, 28);
INSERT INTO `DB_GUI`.`User_info` (`userid`, `fName`, `lName`, `Height`, `Weight`, `Age`) VALUES (4, 'John', 'Doe', 6.3, 210, 25);
